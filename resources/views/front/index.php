...
<html>
    <head>
        ...
        <link href="<?=URL::to('admin/css/datatables/dataTables.bootstrap.css');?>" rel="stylesheet" type="text/css" />
        ...
        <script src="<?=URL::to('admin/js/plugins/datatables/jquery.dataTables.js');?>" type="text/javascript"></script>
        <script src="<?=URL::to('admin/js/plugins/datatables/dataTables.bootstrap.js');?>" type="text/javascript"></script>
